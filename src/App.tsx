      ...
      >
        <div className="flex items-center gap-8 md:gap-14">
          ...
          <motion.div
            ...
            className="flex gap-6 md:gap-8 text-[14px] font-medium"
          >
            {[
        ...
        >
          <button
            ...
            className="px-6 py-1.5 rounded-full border border-black/20 hover:border-black hover:bg-black hover:text-white transition-all duration-300 text-[14px] font-medium cursor-pointer"
          >
            resume
          </button>
        </motion.div>
